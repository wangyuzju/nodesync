...
(function() {
  ...
  */
  ...
  initMain = function() {
    ...
    program.option('', '').option('resolve', 'resolve file conflict through svn').option('config', 'modify configuration file').option('', '').option('-f, --force', 'force sync mode, without checking file\'s MD5').option('-b, --beta', 'beta version, only stable on linux').option('-d, --debug', 'show more detailed debug info').version('0.0.10', '-v, --version');
